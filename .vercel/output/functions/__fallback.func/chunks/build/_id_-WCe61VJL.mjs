import { c as useRoute, b as useRouter, _ as __nuxt_component_0 } from './server.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-Dg5Xpzgu.mjs';
import { defineComponent, ref, watch, mergeProps, withCtx, createTextVNode, unref, createVNode, openBlock, createBlock, toDisplayString, withModifiers, withDirectives, vModelText, vModelSelect, Fragment, renderList, vModelCheckbox, isRef, useSSRContext } from 'vue';
  ...
  setup(__props) {
    ...
    const handleSubmit = async () => {
      ...
      try {
        ...
        error.value = ((_a = err.data) == null ? void 0 : _a.message) || err.message || "Failed to update product";
      } finally {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ name: "admin" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<h1 class="text-3xl font-bold text-gray-900"${_scopeId}>Edit Product</h1><p class="mt-2 text-sm text-gray-700"${_scopeId}>Update product information</p></div>`);
            if (unref(loading)) {
              _push2(`<div class="text-center py-12"${_scopeId}><div class="inline-block animate-spin rounded-full h-8 w-8 border-4 border-gray-200 border-t-primary-600"${_scopeId}></div><p class="mt-4 text-gray-600"${_scopeId}>Loading product...</p></div>`);
            } else if (unref(error)) {
            ...
            return [
              createVNode("div", { class: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8" }, [
                createVNode("div", { class: "mb-8" }, [
                  ...
                  createVNode("h1", { class: "text-3xl font-bold text-gray-900" }, "Edit Product"),
                  createVNode("p", { class: "mt-2 text-sm text-gray-700" }, "Update product information")
                ]),
                unref(loading) ? (openBlock(), createBlock("div", {
                  ...
                  createVNode("p", { class: "mt-4 text-gray-600" }, "Loading product...")
                ])) : unref(error) ? (openBlock(), createBlock("div", {
                  key: 1,
                  class: "mb-6 bg-red-50 border border-red-200 rounded-lg p-4 text-red-700"
                }, toDisplayString(unref(error)), 1)) : (openBlock(), createBlock("form", {
                  key: 2,
                  ...
                  createVNode("div", { class: "flex justify-end space-x-3 pt-6 border-t border-gray-200" }, [
                    ...
                    createVNode("button", {
                      ...
                      unref(submitting) ? (openBlock(), createBlock("span", { key: 0 }, "Saving...")) : (openBlock(), createBlock("span", { key: 1 }, "Save Changes"))
                    ], 8, ["disabled"])
                  ])
                ], 32))
              ])
...
//# sourceMappingURL=_id_-WCe61VJL.mjs.map
