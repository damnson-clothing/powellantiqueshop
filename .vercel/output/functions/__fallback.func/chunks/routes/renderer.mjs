...
import { h as buildAssetsURL, b as useRuntimeConfig, i as getResponseStatusText, j as getResponseStatus, k as decodePath, l as defineRenderHandler, m as publicAssetsURL, f as getQuery, c as createError, n as getRouteRules, o as joinURL, u as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Discover unique vintage bags and collectibles at Powell's Antique Shop. Curated selection of imported bags and accessories in Baguio."},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Powell's Antique Shop - Vintage Bags & Collectibles"};
